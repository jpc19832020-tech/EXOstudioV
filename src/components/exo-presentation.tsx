...
export function ExoPresentation() {
  ...
  return (
    <section id="presentacion" className="py-24 bg-gradient-to-b from-muted/30 to-primary/5">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <Card className="h-full bg-card/50 backdrop-blur-sm border-t-4 border-l-4 border-primary border-r-4 border-b-4 border-accent hover:border-t-accent hover:border-l-accent hover:border-r-primary hover:border-b-primary transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
                  <CardContent className="p-8">
                    <motion.div
                      className="w-12 h-12 bg-gradient-to-br from-primary/20 to-accent/20 rounded-lg flex items-center justify-center text-primary mb-6"
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      transition={{ duration: 0.2 }}
                    >
                      {feature.icon}
                    </motion.div>
                    <h3 className="text-xl font-semibold mb-3 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">{feature.title}</h3>
